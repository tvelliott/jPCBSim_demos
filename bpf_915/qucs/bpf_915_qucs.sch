...
<Properties>
  <View=130,131,1504,861,0.868493,0,0>
  <Grid=10,10,1>
  <DataSet=bpf_915_qucs.dat>
  <DataDisplay=bpf_915_qucs.dpl>
  <OpenDisplay=1>
  <Script=bpf_915_qucs.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  <.SP SP1 1 180 620 0 81 0 0 "log" 1 "0.1MHz" 1 "5GHz" 1 "2000" 1 "no" 0 "1" 0 "2" 0 "no" 0 "no" 0>
  ...
  <SPfile X2 1 790 240 -26 -69 0 0 "/home/radioactive/projects/github/jPCBSim_demos/bpf_915/qucs/bpf_915_qucs.s2p" 1 "rectangular" 0 "linear" 0 "open" 0 "2" 0>
</Components>
<Wires>
